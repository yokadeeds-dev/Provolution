...
**Vorbereitete Antwort:** Eingeräumt: innere Konsistenz ist **nicht** dasselbe wie ein prädiktiver Test. Das J-Veto ist konkret operationalisiert (harte Sperrschwelle). Eine **retrospektive Out-of-sample-Probe** liegt vor (`studies/OUT_OF_SAMPLE_2026-05-30/`, **N=6, Skala 0,085–0,94**): von der Katastrophe (Großer Sprung 1958, 0,085) über PKW-Maut (0,19, J-Veto → EuGH 2019, Art. 18 AEUV) und das instabile Open-House-Maskenverfahren (0,35 — hohes J=0,80 rettet die gebrochene Ausführung S/E/C **nicht**) bis ASFINAG (0,84), Apollo (0,92) und Währungsreform 1948 (0,94). SEC-J trennt monoton+konkordant und **lokalisiert die Fehler-Achse** (PKW-Maut bricht auf J → Veto; Open-House auf S/E/C, kein Veto → achsen-genaue Diagnose statt Skalar). Inkl. Inter-Fall-J-Konsistenz. Offen ausgewiesen: Hindsight-/Single-Rater-Risiko, N=6, retrospektive Anwendung, framework-neutrale Fälle ≠ Climate-Lever-Feldtest.
**Status:** ✅ Probe N=6 (`studies/OUT_OF_SAMPLE_2026-05-30/`) · ⏳ powered/verblindet/prä-registriert + Climate-Lever-Feldtest offen · **Beleg:** LIMITATIONS #9, #13.
