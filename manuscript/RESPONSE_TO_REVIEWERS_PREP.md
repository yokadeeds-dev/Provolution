...
**Vorbereitete Antwort:** Eingeräumt: innere Konsistenz ist **nicht** dasselbe wie ein prädiktiver Test. Das J-Veto ist konkret operationalisiert (harte Sperrschwelle). Eine **illustrative retrospektive Konkordanz-Probe (Proof-of-Concept, KEINE Validierungsstudie)** liegt vor (`studies/ILLUSTRATIVE_CASES_2026-05-30/`, **N=7, Skala 0,085–0,94**): von der Katastrophe (Großer Sprung 1958, 0,085) über PKW-Maut (0,19, J-Veto → EuGH 2019, Art. 18 AEUV) und das instabile Open-House-Maskenverfahren (0,35 — hohes J=0,80 rettet die gebrochene Ausführung S/E/C **nicht**) bis ASFINAG (0,84), Apollo (0,92) und Währungsreform 1948 (0,94). SEC-J trennt monoton+konkordant (= *strukturelle* Übereinstimmung, **nicht** prädiktive Validität) und **lokalisiert die Fehler-Achse** (PKW-Maut bricht auf J → Veto; Open-House auf S/E/C, kein Veto → achsen-genaue Diagnose statt Skalar). Offen ausgewiesen: nicht verblindet, Single-Rater, N=7 (nicht powered), retrospektive Anwendung, framework-neutrale Fälle ≠ Climate-Lever-Feldtest. **Wichtig:** im Manuskript/Cover-Letter niemals als „validation" framen — „illustrative case demonstrations".
**Status:** ✅ illustrative Probe N=7 (`studies/ILLUSTRATIVE_CASES_2026-05-30/`) · ⏳ powered/verblindet/prä-registriert (Roadmap Report §7) + Climate-Lever-Feldtest offen · **Beleg:** LIMITATIONS #9, #13.
...
3. **Out-of-sample-Test** — ✅ **illustrative Probe 2026-05-30** (`studies/ILLUSTRATIVE_CASES_2026-05-30/`, **N=7, Skala 0,085–0,94** Proof-of-Concept + Failure-Mode-Lokalisierung: Großer Sprung · PKW-Maut · Open-House-Masken · ASFINAG · Apollo · Währungsreform); ⏳ powered/verblindet/prä-registriert (Roadmap §7) offen — #5
