...
13. **Out-of-sample-Falsifizierung (erste Probe vorhanden).** Innere Konsistenz (§9) ist nicht dasselbe wie ein prädiktiver Test. Eine **retrospektive Konkordanz-Probe** liegt vor: [`studies/OUT_OF_SAMPLE_2026-05-30/`](../studies/OUT_OF_SAMPLE_2026-05-30/OUT_OF_SAMPLE_VALIDATION.md) — N=7 über die volle Skala (0,085–0,94): Großer Sprung 1958 (0,085, Katastrophe) · PKW-Maut (0,19, J-Veto, EuGH) · Open-House-Maskenverfahren 2020 (0,35, instabil — hohes J=0,80 rettet die gebrochene Ausführung S/E/C nicht) · ASFINAG (0,84) · Apollo (0,92) · Währungsreform 1948 (0,94). SEC-J trennt **monoton und konkordant** zum dokumentierten Ausgang. Zusätzlich **Failure-Mode-Lokalisierung**: die gebrochene Achse sagt die Art des Scheiterns vorher (PKW-Maut bricht auf J → Veto → juristische Kassation; Open-House auf S/E/C → operativer Kollaps, kein Veto) — achsen-genaue Diagnose, nicht nur Ranking. Plus Inter-Fall-J-Konsistenz. **Offen benannt:** Hindsight-/Single-Rater-Risiko, N=7 (Proof-of-Concept), retrospektive Anwendung statt echter Prognose, framework-neutrale Fälle ≠ Climate-Lever-Feldtest. Ein **powered, verblindeter, prä-registrierter** Test bleibt die härtere nächste Stufe.
