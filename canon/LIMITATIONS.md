...
13. **Out-of-sample-Falsifizierung (erste Probe vorhanden).** Innere Konsistenz (§9) ist nicht dasselbe wie ein prädiktiver Test. Eine erste **retrospektive Konkordanz-Probe** liegt vor: [`studies/OUT_OF_SAMPLE_2026-05-30/`](../studies/OUT_OF_SAMPLE_2026-05-30/OUT_OF_SAMPLE_VALIDATION.md) — über die volle Skala (N=3): deutsche PKW-Maut (SEC-J 0,19, J-Veto auf C+J → vom EuGH 2019 gekippt) vs. diskriminierungsfreies ASFINAG-System (0,84, durabel) vs. Währungsreform 1948 als Positiv-Pol (0,94). SEC-J trennt scharf, der Diskriminator ist C/J. Inkl. Inter-Fall-J-Konsistenz (warum 0,15-Veto vs. 0,85: diskriminierend-by-design vs. symmetrische Regel mit regressiver Inzidenz). **Offen benannt:** Hindsight-/Single-Rater-Risiko, N=3 (Proof-of-Concept), retrospektive Anwendung statt echter Prognose, framework-neutrale Fälle ≠ Climate-Lever-Feldtest. Ein **powered, verblindeter, prä-registrierter** Test bleibt die härtere nächste Stufe.
