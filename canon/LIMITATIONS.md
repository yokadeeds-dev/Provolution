...
13. **Out-of-sample-Falsifizierung (erste Probe vorhanden).** Innere Konsistenz (§9) ist nicht dasselbe wie ein prädiktiver Test. Eine erste **retrospektive Konkordanz-Probe** liegt vor: [`studies/OUT_OF_SAMPLE_2026-05-30/`](../studies/OUT_OF_SAMPLE_2026-05-30/OUT_OF_SAMPLE_VALIDATION.md) — die deutsche PKW-Maut (SEC-J 0,19, J-Veto auf C+J) gegen einen diskriminierungsfreien Kontrast (0,78); SEC-J markiert genau die Bruchstelle, die der EuGH 2019 bestätigte. **Offen benannt:** Hindsight-/Single-Rater-Risiko, N=2 (Proof-of-Concept), retrospektive Anwendung statt echter 2019-Prognose. Ein **powered, verblindeter, prä-registrierter** Test bleibt die härtere nächste Stufe.
