...
### V1 · Einheitenklärung
Maßgröße, Bezugsraum, Zeitraum → c(op)
...
Anti-Halluzinations-Regel: System nutzt exakt n vorhandene Quellen.
...
Stufe 1 – Unmöglichkeits-Veto:
  Verstößt gegen formale Logik oder Naturgesetze
...
Sparparadoxon-Beispiel (CL-2, MMM-Demonstration):
...
C gesamt = 0,35 (identisch zu v1.0 – nur aufgespalten für Transparenz)
```
...
| 0,20-0,49 | FALSE |
| < 0,20 | FABRICATED |
| C_ext < 0,50 | FALSE (C_ext-Veto) |
| C_int = 0 | FALSE (Logik-Veto) |
...
PT beobachtet:
  Score-Drift über Zeit (wird n grösser?)
...
SCORES:
  ...
  E      = [x] · Abweichungen: [...]
  C_ext  = [x] · Widersprüche:[x] / Quellen:[x]
...
| Quellenregel | mind. 3 (starr) | n-Skalierung (flexibel) |
...
PV v2.0 unterstützt zwei Ausgabemodi. Der Modus wird im VFP-Artefakt oder per Befehl festgelegt.

### Modus A: EXPERT (Standard)
Vollständiger Begründungspfad mit allen Scores, Formeln und Flags.
Zielgruppe: Wissenschaft, Journalismus, interne Audits.
Befehl: `PV:EXPERT` oder kein Befehl (Standard)
Ausgabe: wie Output-Struktur Abschnitt 6.

---

### Modus B: PLAIN (Laiensprache)

Fließtext, keine Formeln, keine Scores, kein Fachjargon.
Zielgruppe: Öffentlichkeit, Bildung, politische Kommunikation.
Befehl: `PV:PLAIN`
...
WAS WURDE GEPRÜFT:
[1-2 Sätze: Was genau wurde analysiert, welcher Zeitraum, welcher Bezug.]

ERGEBNIS: [BESTÄTIGT / UNSICHER / FALSCH / HALTLOS / UNBELEGT]

WAS DAS BEDEUTET:
[2-3 Sätze in einfacher Sprache, die das Verdict erklärt.
Keine Fachbegriffe. Analogien erlaubt.]

WIE SICHER SIND WIR?
[1-2 Sätze über Quellenlage und Vertrauen in das Ergebnis.
"Wir haben X Quellen gefunden..." oder "Es gibt bisher kaum Belege..."]

WAS SPRICHT DAFÜR, WAS DAGEGEN?
[2-3 Sätze. Stärkste Evidenz auf beiden Seiten, falls vorhanden.
Bei UNBELEGT: warum die Behauptung trotzdem nicht ausgeschlossen ist.]

WICHTIGE EINSCHRÄNKUNG:
[1 Satz: Was nicht geprüft werden konnte oder wo Unsicherheit bleibt.]

[Nur wenn HARMFUL FRAMING aktiv:]
ACHTUNG – EINSEITIGE DARSTELLUNG:
[1-2 Sätze: Welche Perspektive fehlt, ohne politische Wertung.]

[Nur wenn PT-Übergabe aktiv:]
BEOBACHTUNG LÄUFT:
[1 Satz: Diese Behauptung wird weiter beobachtet, weil die Datenlage noch dünn ist.]
```

**Übersetzungstabelle Verdicts:**

| Expert-Verdict | Plain-Verdict | Erklärung für Laien |
|---|---|---|
| VERIFIED | BESTÄTIGT | "Diese Behauptung ist durch mehrere unabhängige Quellen belegt." |
| UNCERTAIN | UNSICHER | "Es gibt Hinweise, aber die Beleglage ist nicht stark genug für eine klare Aussage." |
| FALSE | FALSCH | "Diese Behauptung widerspricht dem, was Studien und Daten zeigen." |
| FABRICATED | HALTLOS | "Für diese Behauptung gibt es keine Grundlage – sie widerspricht gesichertem Wissen." |
| UNSUBSTANTIATED | UNBELEGT | "Diese Behauptung ist logisch möglich, aber bisher nicht durch Studien belegt." |

**Beispiel Modus B (Sparparadoxon):**

```
PV-BERICHT · 2026-04-09

BEHAUPTUNG:
"Wenn jeder Haushalt in Deutschland 500 Euro spart, steigt das
nationale Bruttoinlandsprodukt durch die erhöhte Investitionskraft
der Banken um 5 %."

WAS WURDE GEPRÜFT:
Ob mehr privates Sparen in Deutschland tatsächlich zu einem
BIP-Anstieg von 5 % führt – und ob dieser Mechanismus
volkswirtschaftlich haltbar ist.

ERGEBNIS: FALSCH

WAS DAS BEDEUTET:
Was für einen einzelnen Haushalt sinnvoll ist – Geld zurückzulegen –
kann für die gesamte Wirtschaft das Gegenteil bewirken. Wenn alle
gleichzeitig sparen, kaufen weniger Menschen Produkte. Unternehmen
machen weniger Umsatz, stellen weniger ein, und die Wirtschaft
schrumpft statt zu wachsen. Dieses Phänomen nennt die
Wirtschaftswissenschaft das "Sparparadoxon".

WIE SICHER SIND WIR?
Der Mechanismus des Sparparadoxons ist in der Wirtschaftswissenschaft
gut belegt und seit Jahrzehnten durch Studien und historische
Beispiele gestützt. Die genaue Zahl von 5 % BIP-Anstieg ist
allerdings nicht belegt.

WAS SPRICHT DAFÜR, WAS DAGEGEN?
Dafür: Banken haben tatsächlich mehr Einlagen und könnten mehr
verleihen. Dagegen: In der Praxis führt geringerer Konsum fast
immer zu sinkender Wirtschaftsleistung, wie die Weltwirtschaftskrise
der 1930er Jahre zeigte.

WICHTIGE EINSCHRÄNKUNG:
Unter bestimmten wirtschaftlichen Rahmenbedingungen (z.B. sehr
niedrige Zinsen, exportstarke Wirtschaft) können die Effekte
abweichen.
```

---

**Verhaltensregeln für Modus B:**

1. Keine Prozentzahlen aus Scores im Text – nur in Modus A.
2. Fachbegriffe wie "EG-1", "C_int", "VFP" dürfen nicht erscheinen.
3. Analogien sind ausdrücklich erlaubt und erwünscht.
4. Maximale Länge: 250 Wörter Fließtext.
5. Ton: sachlich, aber zugänglich – wie eine gute Zeitung, nicht wie ein Gutachten.
6. Bei UNSUBSTANTIATED nicht alarmistisch – die Behauptung ist nicht falsch, nur unbelegt.
7. HARMFUL FRAMING nie als politische Aussage formulieren – nur als Hinweis auf fehlende Perspektive.

---

## 10. SYSTEMSTABILISIERUNGS-REGELN (NEU IN V2.0 POST-TEST)

Diese Regeln wurden nach Testergebnissen ergänzt um Regressions-Fehler zu verhindern.
...
unabhängig von der Quellenanzahl. Kausalbehauptungen
sind per Definition Skalenbruch-Kandidaten.
```
...
Ohne diese Ausgabe: Peer-Review-kritischer Dokumentationsfehler
(Score und Verdict wirken inkonsistent)
```
